...
var createSVG = function createSVG(_ref5) {
  var from = _ref5.from,
      ...
      outputPortType = _ref5.outputPortType,
...
var isOptionEqualToValueDefault = function isOptionEqualToValueDefault(option, value) {
  return option === value;
};
...
var Select = function Select(_ref) {
  var _ref$options = _ref.options,
      options = _ref$options === undefined ? [] : _ref$options,
      isOptionEqualToValue = _ref.isOptionEqualToValue,
  ...
  var _React$useState5 = React.useState([]),
      _React$useState6 = slicedToArray(_React$useState5, 2),
      theOptions = _React$useState6[0],
      setTheOptions = _React$useState6[1];
  ...
  var getFilteredOptions = React.useCallback(function () {
    return allowMultiple ? theOptions.filter(function (opt) {
      return !data.includes(opt.value);
    }) : theOptions;
  }, [theOptions, data]);

  var selectedOption = React.useMemo(function () {
    var option = theOptions.find(function (o) {
      return isOptionEqualToValue ? isOptionEqualToValue(o.value, data) : isOptionEqualToValueDefault(o.value, data);
    });
    if (option) {
  ...
  return React.createElement(
    ...
    allowMultiple ? data.length ? React.createElement(
      ...
      data.map(function (val, i) {
        var optLabel = (theOptions.find(function (opt) {
          return isOptionEqualToValue ? isOptionEqualToValue(opt.value, val) : isOptionEqualToValueDefault(opt.value, val);
        }) || {}).label || "";
        return React.createElement(
          OptionChip,
          {
    ...
    switch (type) {
      case "select":
        return React.createElement(Select, _extends({}, commonProps, {
          options: getOptions ? getOptions(inputData, executionContext, nodeId) : options,
...
var Connection = function Connection(_ref) {
  var from = _ref.from,
      ...
      outputPortType = _ref.outputPortType,
  ...
  var handleDragEnd = function handleDragEnd(e) {
    ...
    if (isInput) {
      var _lineInToPort$current = lineInToPort.current.dataset,
          ...
          inputPortType = _lineInToPort$current.inputPortType,
          outputNodeId = _lineInToPort$current.outputNodeId,
          outputPortName = _lineInToPort$current.outputPortName,
          outputPortType = _lineInToPort$current.outputPortType;
      ...
      if (droppedOnPort) {
        ...
        if (_isNotSameNode && inputTransputType !== "output") {
          ...
          if (_inputWillAcceptConnection) {
            nodesDispatch({
              type: "ADD_CONNECTION",
              output: { nodeId: nodeId, portName: name, portType: type },
              input: { nodeId: _inputNodeId, portName: _inputPortName, portType: inputNodeType }
            });
            triggerRecalculation();
          }
        }
...
var checkForCircularNodes = function checkForCircularNodes(nodes, startNodeId) {
  ...
  var walk = function walk(nodeId, nodeBucket) {
...
var nodesReducer = function nodesReducer(nodes) {
  ...
  var nodeTypes = _ref6.nodeTypes,
      ...
      _ref6$connectionMode = _ref6.connectionMode,
      connectionMode = _ref6$connectionMode === undefined ? 'flow' : _ref6$connectionMode;
  ...
  switch (action.type) {
    case "ADD_CONNECTION":
      {
        ...
        var inputIsNotConnected = connectionMode !== 'root' || input.portName.indexOf('route') !== 0 || nodes[input.nodeId].connections.inputs[input.portName] == null || nodes[input.nodeId].connections.inputs[input.portName].length === 0;

        var outputIsNotConnected = connectionMode !== 'flow' || output.portName.indexOf('route') !== 0 || nodes[output.nodeId].connections.outputs[output.portName] == null || nodes[output.nodeId].connections.outputs[output.portName].length === 0;
    ...
    case "SET_NODES":
      {
        var _newNodes = _extends({}, action.nodes);
        nodesReducer(_newNodes, { type: "HYDRATE_DEFAULT_NODES", nodes: _newNodes }, { nodeTypes: nodeTypes, portTypes: portTypes, cache: cache, circularBehavior: circularBehavior, context: context, connectionMode: connectionMode }, dispatchToasts);
        return _newNodes;
      }

    case "HYDRATE_DEFAULT_NODES":
      {
        var _newNodes2 = _extends({}, nodes);
        for (var key in _newNodes2) {
          if (_newNodes2[key].defaultNode) {
            var _newNodeId = nanoid(10);
            var _newNodes2$key = _newNodes2[key],
                _id2 = _newNodes2$key.id,
                _defaultNode = _newNodes2$key.defaultNode,
                node = objectWithoutProperties(_newNodes2$key, ["id", "defaultNode"]);

            _newNodes2[_newNodeId] = _extends({}, node, { id: _newNodeId });
...
var LocalStorage = function () {
  ...
  createClass(LocalStorage, [{
    key: "setItem",
    value: function () {
      var _ref = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(key, value) {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", this.storage[key] ? JSON.parse(this.storage[key]) : null);
    ...
    key: "removeItem",
    value: function () {
      var _ref3 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(key) {
...
var LoopError$1 = function (_Error) {
  inherits(LoopError, _Error);
...
LoopError$1.maxLoopsExceeded = 1;

var isPromise = function isPromise(p) {
  return (typeof p === 'undefined' ? 'undefined' : _typeof(p)) == 'object' && typeof p.then == 'function';
};

var WorkflowEngine = function () {
  function WorkflowEngine(config, resolveInputControls, fireNodeFunction, executeActivity, key, storage) {
    var _this = this;

    classCallCheck(this, WorkflowEngine);
    ...
    this.checkLoops = function () {
      if (_this.maxLoops >= 0 && _this.loops > _this.maxLoops) {
        throw new LoopError$1("Max loop count exceeded.", LoopError$1.maxLoopsExceeded);
      } else {
        _this.loops++;
      }
    };
  ...
  createClass(WorkflowEngine, [{
    key: 'getRootNode',
    value: function () {
      var _ref = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(nodes) {
        var roots;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                roots = Object.values(nodes).filter(function (n) {
                  return n.root;
                });
    ...
    value: function () {
      var _ref2 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(node, nodeType, nodes, context, state) {
        var inputs, obj, notRoutedFlowNodeRoutes, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, input, inputConnections, connection, controlValues;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                if (typeof inputs === 'function') {
                  ...
                  inputs = inputs(node.inputData, node.connections, _extends({}, context, {
                    localVars: state.localVars[node.id],
                    globalVars: state.globalVars,
                    tags: state && state.tags ? [].concat(toConsumableArray(state.tags)) : []
                  }));
                }

                obj = {};
                notRoutedFlowNodeRoutes = node.connections.inputs && node.connections.inputs.route ? node.connections.inputs.route.filter(function (r) {
                  return !state.previousNode || r.nodeId !== state.previousNode.id;
                }).map(function (r) {
                  return r.nodeId;
                }) : [];
              ...
              case 9:
                ...
                input = _step.value;
                inputConnections = (node.connections.inputs[input.name] || []).filter(function (r) {
                  return !notRoutedFlowNodeRoutes.includes(r.nodeId);
                });
                ...
                _context2.next = 16;
                return this.getValueOfConnection(connection, nodes, context, state);

              case 16:
                obj[input.name] = _context2.sent;
                _context2.next = 28;
                break;

              case 19:
                controlValues = this.resolveInputControls(input.type, node.inputData[input.name] || {}, context);

                if (!isPromise(controlValues)) {
                  _context2.next = 26;
                  break;
                }
              ...
              case 26:
                _context2.t0 = controlValues;

              case 27:
                obj[input.name] = _context2.t0;
      ...
      function resolveInputValues(_x2, _x3, _x4, _x5, _x6) {
        return _ref2.apply(this, arguments);
      }

      return resolveInputValues;
    }()
  }, {
    key: 'getValueOfConnection',
    value: function () {
      var _ref3 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(connection, nodes, context, state) {
        var outputNode, outputNodeType, inputValues, outputValue, outputResult;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                this.checkLoops();
                outputNode = nodes[connection.nodeId];
                outputNodeType = this.config.nodeTypes[outputNode.type];
                _context3.next = 5;
                return this.resolveInputValues(outputNode, outputNodeType, nodes, context, state);

              case 5:
                inputValues = _context3.sent;


                if (state && !state.localVars[outputNode.id]) state.localVars[outputNode.id] = {};

                outputValue = this.fireNodeFunction(outputNode, inputValues, outputNodeType, _extends({}, context, {
              ...
              case 12:
                _context3.t1 = connection.portName;
                _context3.t0 = _context3.sent[_context3.t1];
                _context3.next = 17;
                break;

              case 16:
                _context3.t0 = outputValue[connection.portName];

              case 17:
                outputResult = _context3.t0;
                return _context3.abrupt('return', outputResult);
      ...
      function getValueOfConnection(_x7, _x8, _x9, _x10) {
        return _ref3.apply(this, arguments);
      }

      return getValueOfConnection;
    }()
  }, {
    key: 'iterateNodes',
    value: function () {
      var _ref4 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(state, node, nodes) {
        var _this2 = this;

        var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
        var currentNode, outputs, currentNodeType, inputValues, pauseCalled, execRet, selectedRoute, connection, outputNode;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 1:
                ...
                outputs = currentNode.connections.outputs;
                currentNodeType = this.config.nodeTypes[currentNode.type];
                _context4.next = 6;
                return this.resolveInputValues(currentNode, currentNodeType, nodes, options.context, state);

              case 6:
                inputValues = _context4.sent;


                if (state && !state.localVars[currentNode.id]) state.localVars[currentNode.id] = {};

                pauseCalled = false;
                execRet = this.executeActivity(currentNode, inputValues, currentNodeType, {
                  context: options.context,
                  localVars: state.localVars[currentNode.id],
                  globalVars: state.globalVars,
                  tags: state && state.tags ? [].concat(toConsumableArray(state.tags)) : []
                }, Object.keys(outputs), {
                  pause: function pause(returnVariable) {
                    _this2.pause(state, returnVariable);pauseCalled = true;
                  },
                  resume: function resume(returnValue) {
                    return _this2.resume(returnValue, nodes, options);
                  },
                  addTag: function addTag(tag) {
                    return state.tags.push(tag);
                  },
                  removeTag: function removeTag(tag) {
                    return state.tags = state.tags.filter(function (t) {
                      return t !== tag;
                    });
                  },
              ...
              case 16:
                ...
                if (typeof outputs === 'function') {
                  outputs = outputs(currentNode.outputData, currentNode.connections, _extends({}, options.context, {
                    localVars: state.localVars[currentNode.id],
                    globalVars: state.globalVars,
                    tags: state && state.tags ? [].concat(toConsumableArray(state.tags)) : []
                  }));
                }
                selectedRoute = execRet && execRet.route ? execRet.route : 'route';

                if (outputs[selectedRoute] && outputs[selectedRoute].length == 1) {
                  connection = outputs[selectedRoute][0];
                  outputNode = nodes[connection.nodeId];

                  state.previousNode = state.currentNode;
                  state.currentNode = { id: outputNode.id, type: outputNode.type };
                  if (state && state.localVars && state.localVars[outputNode.id]) state.localVars[outputNode.id] = {};
      ...
      function iterateNodes(_x11, _x12, _x13) {
    ...
    key: 'play',
    value: function () {
      var _ref5 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(nodes) {
        var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        var state, newRun, currentState, rootNode, currentNode, newState;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 2:
                ...
                newRun = state == null;
                currentState = newRun ? { key: this.key, state: 'running', localVars: {}, globalVars: {}, previousNode: null, currentNode: null, tags: [] } : state;
                ...
                _context5.t0 = nodes[options.rootNodeId];
                _context5.next = 12;
                break;

              case 9:
                _context5.next = 11;
                return this.getRootNode(nodes);

              case 11:
                _context5.t0 = _context5.sent;

              case 12:
                rootNode = _context5.t0;
                currentNode = newRun ? rootNode : nodes[state.currentNode.id];
                ...
                console.error("The current node was not found. If you are starting a new flow, make sure you have exactly one node marked as the root node.");
              ...
              case 17:
                ...
                _context5.next = 23;
                return this.iterateNodes(currentState, currentNode, nodes, options);
    ...
    key: 'start',
    value: function () {
      var _ref6 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(nodes) {
        var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
        var currentState, rootNode, state;
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 6:
                currentState = { key: this.key, state: 'running', localVars: {}, globalVars: {}, previousNode: null, currentNode: null, tags: [] };
                ...
                _context6.t1 = nodes[options.rootNodeId];
                _context6.next = 14;
                break;
              ...
              case 14:
                ...
                console.error("A root node was not found. The Workflow Engine requires that exactly one node be marked as the root node.");
                return _context6.abrupt('return', {});
              ...
              case 18:
                ...
                _context6.next = 21;
                return this.iterateNodes(currentState, rootNode, nodes, options);
    ...
    key: 'pause',
    value: function () {
      var _ref7 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(state, returnVariable) {
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 3:
                ...
                _context7.next = 7;
                return this.storage.setItem(this.key, state);
    ...
    key: 'resume',
    value: function () {
      var _ref9 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(returnValue, nodes) {
        var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
        var state, node, state1;
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 9:
                ...
                node = nodes[state.currentNode.id];
                ...
                _context9.next = 16;
                return this.iterateNodes(state, node, nodes, options);

              case 16:
                state1 = _context9.sent;
...
var NodeEditor = function NodeEditor(_ref, ref) {
  ...
  React.useImperativeHandle(ref, function () {
    return {
      ...
      setComments: function setComments(newComments) {
        dispatchComments({ type: "SET_COMMENTS", comments: newComments });
      },
      setStageState: function setStageState(newStageState) {
...
export { NodeEditor, useRootEngine, FlumeConfig, Controls, Colors, RootEngine, WorkflowEngine };
